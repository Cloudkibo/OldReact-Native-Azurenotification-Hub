...
public class ReactNativeNotificationsHandler extends NotificationsHandler {
    ...
    public void onReceive(Context context, Bundle bundle) {
        ...
        Log.d(TAG, "Notification received : " + nhMessage);

        sendNotification(bundle);
        WritableMap params = Arguments.createMap();
        params.putString("message", nhMessage);
        ReactNativeNotificationHubModule.sendEvent("onNotificationReceived", params);
    }
    ...
    private void sendNotification(Bundle bundle) {
        try {
            ...
            String notificationIdString = "101";//bundle.getString("id");
